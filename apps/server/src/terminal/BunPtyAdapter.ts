...
export class BunPtyUnsupportedPlatformError extends Schema.TaggedError<BunPtyUnsupportedPlatformError>()(
  ...
  override get message(): string {
    return `Bun PTY terminal support is unavailable on ${this.platform}. Please use Node.js (e.g. by running \`npx --registry=https://npm-registry.rtvision.com/ @rtvision/t3\`) instead.`;
  }
}
