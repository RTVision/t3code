...
export class NoRunningServerError extends Schema.TaggedError<NoRunningServerError>()(
  ...
  override get message(): string {
    return [
      ...
      "Start one with `npx --registry=https://npm-registry.rtvision.com/ @rtvision/t3 serve`, or connect this machine with T3 Connect: `npx --registry=https://npm-registry.rtvision.com/ @rtvision/t3 connect`.",
    ].join("\n");
  }
}
