...
describe("siblingPullRequestUrl", () => {
  it.each([
    [
      "https://forge.example.test/gitea/acme/web/pulls/42/files",
      "https://forge.example.test/gitea/acme/web/pulls/43",
    ],
    [
      "https://forge.example.test/acme/web/pulls/42#review",
      "https://forge.example.test/acme/web/pulls/43",
    ],
